...
class TextThemeDark {
  ...
  final TextStyle headline1 =
      const TextStyle(fontFamily: ApplicationConstants.FONT_FAMILY, fontWeight: FontWeight.w600, fontSize: 96, letterSpacing: -1.5);
  final TextStyle headline2 =
      const TextStyle(fontFamily: ApplicationConstants.FONT_FAMILY, fontWeight: FontWeight.w600, letterSpacing: -0.5, fontSize: 60);
  ...
  final TextStyle headline4 =
      const TextStyle(fontFamily: ApplicationConstants.FONT_FAMILY, fontWeight: FontWeight.w600, letterSpacing: 0.25, fontSize: 34);
